...
- Production evaluation accepts only externally sourced GitHub skills with a real repository and body location. Seed, local, or self-authored routing cards must not be used as evidence of search quality or task improvement.
